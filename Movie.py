{
 "cells": [
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "movies = pd.read_csv(r\"C:\\Users\\91772\\Downloads\\tmdb_5000_movies.csv\")\n",
    "\n"
   ]
  },
  {
   ...
   "outputs": [],
   "source": [
    "credits = pd.read_csv(r\"C:\\Users\\91772\\Downloads\\tmdb_5000_credits.csv\")"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "#columns I need: genre,id,keywords,title,overview,cast,crew"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "#remove spaces to differentiate same names"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "df['tags']=df['genres']+df['overview']+df['genres']+df['keywords']+df['cast']+df['crew']"
   ]
  },
  {
   "cell_type": "code",
   ...
   "outputs": [
    ...
    },
    {
     ...
     "text": [
      ...
      "[notice] To update, run: C:\\Users\\91772\\AppData\\Local\\Microsoft\\WindowsApps\\PythonSoftwareFoundation.Python.3.11_qbz5n2kfra8p0\\python.exe -m pip install --upgrade pip\n"
     ]
    },
    {
     "name": "stdout",
     "output_type": "stream",
     "text": [
      "Requirement already satisfied: scikit-learn in c:\\users\\91772\\appdata\\local\\packages\\pythonsoftwarefoundation.python.3.11_qbz5n2kfra8p0\\localcache\\local-packages\\python311\\site-packages (1.7.2)\n",
      "Requirement already satisfied: numpy>=1.22.0 in c:\\users\\91772\\appdata\\local\\packages\\pythonsoftwarefoundation.python.3.11_qbz5n2kfra8p0\\localcache\\local-packages\\python311\\site-packages (from scikit-learn) (2.0.2)\n",
      "Requirement already satisfied: scipy>=1.8.0 in c:\\users\\91772\\appdata\\local\\packages\\pythonsoftwarefoundation.python.3.11_qbz5n2kfra8p0\\localcache\\local-packages\\python311\\site-packages (from scikit-learn) (1.16.2)\n",
      "Requirement already satisfied: joblib>=1.2.0 in c:\\users\\91772\\appdata\\local\\packages\\pythonsoftwarefoundation.python.3.11_qbz5n2kfra8p0\\localcache\\local-packages\\python311\\site-packages (from scikit-learn) (1.4.2)\n",
      "Requirement already satisfied: threadpoolctl>=3.1.0 in c:\\users\\91772\\appdata\\local\\packages\\pythonsoftwarefoundation.python.3.11_qbz5n2kfra8p0\\localcache\\local-packages\\python311\\site-packages (from scikit-learn) (3.6.0)\n"
     ]
    }
   ],
   "source": [
   ...
   "outputs": [
    {
     "data": {
      "text/plain": [
       "array([[1.        , 0.21622499, 0.18131017, ..., 0.05132894, 0.        ,\n",
       "        0.        ],\n",
       "       [0.21622499, 1.        , 0.18295102, ..., 0.01726449, 0.        ,\n",
       "        0.02010076],\n",
       "       [0.18131017, 0.18295102, 1.        , ..., 0.01930229, 0.        ,\n",
       "        0.        ],\n",
       "       ...,\n",
       "       [0.05132894, 0.01726449, 0.01930229, ..., 1.        , 0.03860457,\n",
       "        0.03817322],\n",
       "       [0.        , 0.        , 0.        , ..., 0.03860457, 1.        ,\n",
       "        0.08989331],\n",
       "       [0.        , 0.02010076, 0.        , ..., 0.03817322, 0.08989331,\n",
       "        1.        ]])"
      ]
     },
     "execution_count": 76,
   ...
   "outputs": [
    {
     "data": {
      "text/plain": [
       "2610      Black Snake Moan\n",
       "1762             Anonymous\n",
       "1461    Lion of the Desert\n",
       "2791    The Emperor's Club\n",
       "3755      The Great Escape\n",
  ...
  },
  {
   ...
   "source": [
    "import json\n",
    "\n",
    "file_path = r\"C:\\Users\\91772\\Downloads\\ML_project\\Recommendation_System\\Movie.ipynb\"\n",
    "\n",
    "try:\n",
    "    with open(file_path, 'r', encoding='utf-8') as f:\n",
    "        data = json.load(f)\n",
    "    print(\"The notebook is valid JSON.\")\n",
